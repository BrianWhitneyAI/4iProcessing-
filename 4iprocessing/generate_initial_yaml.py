...
# need to document virtual environment
### need a conda yml
### then a pip requirements.txt
...
bdirlist = [r"\\allen\aics\microscopy\Antoine\Analyse EMT\4i Data\5500000733 (Control wells)",
    ...
    for scope in scope_list:
        ...
        for round_num in round_list:
            ...
            for czi_name in czi_list:
                ...
                ref_channel = -2
                if bool(re.search('time|1(?![0-9])',round_num,re.IGNORECASE)): # TODO: make sure this doesn't capture round 11
        ...
        yamd['output_path'] = '//allen/aics/assay-dev/users/Frick/PythonProjects/Assessment/4i_testing/aligned_4i_exports'
        
        

    
    #### code for aligning and renaming rounds consistently
#     new_round_list=[]
#         for round_name in round_list:
            
#             if bool(re.search('Round [0-9]+',round_name,re.IGNORECASE)):
#                 num = re.search('[0-9]+',round_name).group(0)
#                 new_round_name = f'Round {str(num).zfill(2)}'
#                 print(round_name,new_round_name)
#             else:
#                 new_round_name = round_name
#             new_round_list.append(new_round_name)
