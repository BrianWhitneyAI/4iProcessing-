...
parser.add_argument("--matched_position_csv_parent_dir", type=str, required=False, help="Matched position csv dirs. If this argument is given, this runs find_alignment_parameters.py ")
parser.add_argument("--matched_position_w_align_params_csv_parent_dir", type=str, required=False, help="Matched position csv with alignment parent dir. If this argument is given, this runs apply_registration.py")
...
if __name__ == "__main__":
    ...
    for i in range(len(position_csv_list)):
        ...
        if os.path.exists(args.matched_position_csv_parent_dir):
            # import pdb
            # pdb.set_trace()
            render_dict_slurm = {
            ...
            script_path = os.path.join(args.batch_process_dir, "jinja_output",  f"position_{i}.out")  # noqa E501'
            print(script_path)
